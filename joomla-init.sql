...
(27, 8, 18, 19, 2, 'com_content.category.2', 'Non catégorisé', '{}'),
(28, 3, 4, 5, 2, 'com_banners.category.3', 'Non catégorisé', '{}'),
(29, 7, 14, 15, 2, 'com_contact.category.4', 'Non catégorisé', '{}'),
(30, 19, 76, 77, 2, 'com_newsfeeds.category.5', 'Non catégorisé', '{}'),
(32, 24, 88, 89, 2, 'com_users.category.7', 'Non catégorisé', '{}'),
...
INSERT INTO `joo_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `joo_fields`
--
...
--
-- Table structure for table `joo_fields_categories`
--
...
--
-- Table structure for table `joo_fields_groups`
--
...
--
-- Table structure for table `joo_fields_values`
--
